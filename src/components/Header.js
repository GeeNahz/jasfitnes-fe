...
const Header = () => {
    ...
    return (
        <>
            <motion.div className='flex w-full h-hero-img relative mt-12'>
                <img src={image} alt="images" className='min-w-full h-full'/>
                <div className='flex flex-col bg-black bg-opacity-60 absolute top-0 left-0 py-28 px-24 w-full h-full text-left items-start justify-center' >
